      ...
      <div className="flex flex-col items-center justify-center px-6 text-center h-full">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Create a new group or join one with an invite key.
          </p>
        </div>
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-lg font-bold text-foreground leading-snug truncate">Create new group</p>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-lg font-bold text-foreground leading-snug truncate">Join existing group</p>
